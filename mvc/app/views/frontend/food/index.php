...
<head>
  ...
  <link rel="stylesheet" href="<?= ASSETS."/frontend/food/"?>css/External/all.min.css">
  <!-- custom css file LInk -->
  <link rel="stylesheet" href="<?= ASSETS."/frontend/food/"?>css/style.css">
  <title>Food</title>
</head>
<body>
...
<!-- home section start -->
  <section class="home" id="home">
    ...
    <div class="image">
      <img src="<?= ASSETS."/frontend/food/"?>img/home-img.png" alt="">
    </div>
  </section>
<!-- home section end -->
  ...
  <section class="speciality" id="speciality">
    ...
    <div class="box-container">
      <div class="box">
        ...
        <div class="content">
          <img src="<?= ASSETS."/frontend/food/"?>img/s-1.png" alt="">
          <h3>Tasty burger</h3>
      ...
      <div class="box">
        <img class="<?= ASSETS."/frontend/food/"?>image" src="img/s-img-2.jpg" alt="">
        <div class="content">
      ...
      <div class="box">
        ...
        <div class="content">
          <img src="<?= ASSETS."/frontend/food/"?>img/s-3.png" alt="">
          <h3>cold ice-crema</h3>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos culpa amet tenetur, ut architecto animi, unde enim esse alias a soluta. Ipsum magnam corrupti dolorem minima ut numquam dolorum nemo!</p>
        </div>
      </div>
      <div class="box">
        <img class="image" src="<?= ASSETS."/frontend/food/"?>img/s-img-4.jpg" alt="">
        <div class="content">
          <img src="<?= ASSETS."/frontend/food/"?>img/s-4.png" alt="">
          <h3>cold drinks</h3>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos culpa amet tenetur, ut architecto animi, unde enim esse alias a soluta. Ipsum magnam corrupti dolorem minima ut numquam dolorum nemo!</p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="content">
          <img src="<?= ASSETS."/frontend/food/"?>img/s-5.png" alt="">
          <h3>Tasty sweets</h3>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos culpa amet tenetur, ut architecto animi, unde enim esse alias a soluta. Ipsum magnam corrupti dolorem minima ut numquam dolorum nemo!</p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="content">
          <img src="<?= ASSETS."/frontend/food/"?>img/s-6.png" alt="">
...
<!-- popular section starts -->
  <section  class="popular" id="popular">
    ...
    <div class="box-container">
      ...
      <div class="box">
        <span class="price">$5 - $20</span>
        <img src="<?= ASSETS."/frontend/food/"?>img/p-2.jpg" alt="">
        <h3>Tasty cakes</h3>
        <div class="stars">
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
      ...
      <div class="box">
        <span class="price">$5 - $20</span>
        <img src="<?= ASSETS."/frontend/food/"?>img/p-3.jpg" alt="">
        <h3>Tasty sweets</h3>
        <div class="stars">
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
      ...
      <div class="box">
        <span class="price">$5 - $20</span>
        <img src="<?= ASSETS."/frontend/food/"?>img/p-4.jpg" alt="">
      ...
      <div class="box">
        <span class="price">$5 - $20</span>
        <img src="<?= ASSETS."/frontend/food/"?>img/p-5.jpg" alt="">
        <h3>cold drinks</h3>
        <div class="stars">
          <i class="fas fa-star"></i>
          <i class="fas fa-star"></i>
      ...
      <div class="box">
        <span class="price">$5 - $20</span>
        <img src="<?= ASSETS."/frontend/food/"?>img/p-6.jpg" alt="">
...
<div class="loader-container">
  <img src="<?= ASSETS."/frontend/food/"?>img/loader.gif" alt="">
</div>



  <!-- custom js file LInk -->
  <script src="<?= ASSETS."/frontend/food/"?>js/min.js"></script>
</body>
</html>